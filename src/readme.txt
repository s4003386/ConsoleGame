Kai Susanto s4003386- Largely in charge of story, navigation and inventory mechanics. Set up battle initiation as well
The commits for my section can be found here: https://github.com/s4003386/ConsoleGame

Kiera - Largely in charge of battle mechanics and functions. Created player attributes, cards, the fights themselves etc.
Most of my commits can be found in https://github.com/Null0133/Combat

I also would like to apologise if any bugs arose from my mergeing i am still having that issue where it doesnt let me run this because of 
some weird error (exclusive to me i hope)(kai is having no errors but my laptop does (and it doesnt let me fix the error either)).
so if i missed anything i cant tell :D 
